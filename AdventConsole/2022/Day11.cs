...
public class Day11 : IPuzzleDay
{
    public object CalculateAnswerPuzzle1()
    {
        ...
        {
            new(operation1: o => o * 3, operation2: n => n / 3, 5, 2, 7, 78, 53, 89, 51, 52, 59, 58, 85),
            new(operation1: o => o + 7, operation2: n => n / 3, 2, 3, 6, 64),
            new(operation1: o => o + 5, operation2: n => n / 3, 13, 5, 4, 71, 93, 65, 82),
            new(operation1: o => o + 8, operation2: n => n / 3, 19, 6, 0, 67, 73, 95, 75, 56, 74),
            new(operation1: o => o + 4, operation2: n => n / 3, 11, 3, 1, 85, 91, 90),
            new(operation1: o => o * 2, operation2: n => n / 3, 3, 4, 1, 67, 96, 69, 55, 70, 83, 62),
            new(operation1: o => o + 6, operation2: n => n / 3, 7, 7, 0, 53, 86, 98, 70, 64),
            new(operation1: o => o * o, operation2: n => n / 3, 17, 2, 5, 88, 64)
        };
    ...
    public object CalculateAnswerPuzzle2()
    {
        var monkeys = new List<Monkey>
        {
            new(operation1: o => o * 3, operation2: n => n % 9699690, 5, 2, 7, 78, 53, 89, 51, 52, 59, 58, 85),
            new(operation1: o => o + 7, operation2: n => n % 9699690, 2, 3, 6, 64),
            new(operation1: o => o + 5, operation2: n => n % 9699690, 13, 5, 4, 71, 93, 65, 82),
            new(operation1: o => o + 8, operation2: n => n % 9699690, 19, 6, 0, 67, 73, 95, 75, 56, 74),
            new(operation1: o => o + 4, operation2: n => n % 9699690, 11, 3, 1, 85, 91, 90),
            new(operation1: o => o * 2, operation2: n => n % 9699690, 3, 4, 1, 67, 96, 69, 55, 70, 83, 62),
            new(operation1: o => o + 6, operation2: n => n % 9699690, 7, 7, 0, 53, 86, 98, 70, 64),
            new(operation1: o => o * o, operation2: n => n % 9699690, 17, 2, 5, 88, 64)
        };
