...
public class Day12 : IPuzzleDay
{
    ...
    public object CalculateAnswerPuzzle1()
    {
        ...
        VisitNextCave(input.First(c => c.Id == "start"), ref foundRoutes, new());
    ...
    public object CalculateAnswerPuzzle2()
    {
        ...
        {
            VisitNextCave(input.First(c => c.Id == "start"), ref foundRoutes, new(), smallCaveToVisitTwice);
        }
        return foundRoutes.Count;
    ...
    private class Cave : IEquatable<Cave>
    {
        ...
        public HashSet<Cave> Paths { get; } = new();
